<template>
  <footer class="mt-16 pb-16 text-sm leading-6">
      ...
      <div class="flex">
        <div class="flex-none w-1/2 space-y-10 sm:space-y-8 lg:flex lg:space-y-0">
          ...
          <div class="lg:flex-none lg:w-1/2">
            ...
            <ul class="mt-3 space-y-2">
              <li><a class="hover:text-gray-900" href="https://github.com/web-tech-tw/swollen">Swollen</a></li>
              <li><a class="hover:text-gray-900" href="https://github.com/web-tech-tw/sara">Sara 無密碼式身分認證系統</a></li>
              <li><a class="hover:text-gray-900" href="https://github.com/web-tech-tw/meow">meow 微型部落格社交平台</a></li>
              <li><a class="hover:text-gray-900" href="https://github.com/web-tech-tw">更多產品</a></li>
            </ul>
          </div>
        </div>
        <div class="flex-none w-1/2 space-y-10 sm:space-y-8 lg:flex lg:space-y-0">
          <div class="lg:flex-none lg:w-1/2">
            ...
            <ul class="mt-3 space-y-2">
              <li><a class="hover:text-gray-900" href="/mejob/#/hiring">徵才平台</a></li>
              <li><a class="hover:text-gray-900" href="/mejob/#/jobs">求職平台</a></li>
              <li><a class="hover:text-gray-900" href="/mejob/#/chat">職場討論</a></li>
            </ul>
          </div>
          <div class="lg:flex-none lg:w-1/2">
    ...
    <div class="max-w-7xl mx-auto mt-5 divide-y divide-gray-200 px-4 sm:px-6 md:px-8">
      &copy; 2024 臺灣網際網路技術推廣組織 Taiwan Web Technology Promotion Organization (Web Tech TW)
    </div>
  </footer>
</template>
